...
ignore_preflight_errors = params['ignore_preflight_errors']
...
begin
  result = kubeadm_init(apiserver_advertise_address, apiserver_bind_port, apiserver_cert_extra_sans, cert_dir, config, dry_run,
                        feature_gates, ignore_preflight_errors, kubernetes_version, node_name, pod_network_cidr, service_cidr,
                        service_dns_domain, skip_preflight_checks, skip_token_print, token, token_ttl)
