...
RSpec.configure do |c|
  ...
  c.before :suite do
    ...
    puppet_module_install(source: proj_root, module_name: 'kubernetes')
    hosts.each do |host|
      on host, puppet('module', 'install', 'puppetlabs-stdlib'), acceptable_exit_codes: [0, 1]
      on host, puppet('module', 'install', 'puppetlabs-accounts'), acceptable_exit_codes: [0, 1]
      ...
      on host, puppet('module', 'install', 'puppet-selinux'), acceptable_exit_codes: [0, 1]
      on host, puppet('module', 'install', 'puppetlabs-reboot'), acceptable_exit_codes: [0, 1]
